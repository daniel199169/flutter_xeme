...
class _CoverImageState extends State<CoverImage> {
  ...
  void initState() {
    ...
    data = new CoverImageModel(
        imageURL: "", description: "", tag: "", reference: "");
  ...
  getData() async {
    ...
    CoverImageModel _data =
        await BuildderManager.getCoverImageData(uid, widget.id, widget.type);
    setState(() {
      data = _data;
