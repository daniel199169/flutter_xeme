...
class NotSiLogInDyna extends StatefulWidget {
  NotSiLogInDyna({this.dynalink});
  final String dynalink;

  @override
  State<StatefulWidget> createState() => _NotSiLogInDynaState();
}

class _NotSiLogInDynaState extends State<NotSiLogInDyna> {
...
//          SessionManager.setImage(user.image);
          String xmapId = await BuildderManager.getXmapIDForDynammicLink(
              'Trending', userId, widget.dynalink);
          FadeRoute(page: ViewerInit(id: xmapId, type: "Trending"));
        }
      } catch (e) {
        setState(() {
          _isLoading = false;
