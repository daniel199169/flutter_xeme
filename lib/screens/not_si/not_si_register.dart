...
class NotSiRegister extends StatefulWidget {
  NotSiRegister({this.auth, this.loginCallback});

  BaseAuth auth;
  final VoidCallback loginCallback;

  @override
  _NotSiRegisterState createState() => _NotSiRegisterState();
}

class _NotSiRegisterState extends State<NotSiRegister> {
