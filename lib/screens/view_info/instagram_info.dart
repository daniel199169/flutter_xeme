...
class Instagram extends StatefulWidget {
  ...
  Instagram({this.id, this.type, this.subOrder, this.pageId});
...
class _InstagramState extends State<Instagram> {
  ...
  void addNewCollection(String collectionTitle) async {
    Collection collection = Collection(
        ...
        tag: '',
        reference: '');
    collection.image = instagramList[int.parse(widget.subOrder)].instagramURL;
    collection.videoURL =
        instagramList[int.parse(widget.subOrder)].instagramURL;
    collection.sectionType = 'instagram';
    collection.title = instagramList[int.parse(widget.subOrder)].title;
    collection.description =
        instagramList[int.parse(widget.subOrder)].description;
    collection.tag = instagramList[int.parse(widget.subOrder)].tag;
    collection.reference = instagramList[int.parse(widget.subOrder)].reference;
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: instagramList != 0
                          ? CachedNetworkImage(
                              imageUrl:
                                  instagramList[int.parse(widget.subOrder)]
                                      .instagramURL,
                              width: MediaQuery.of(context).size.width,
                    ...
                    child: Align(
                      ...
                      child: ListView(
                        children: <Widget>[
                          ...
                          Text(
                            instagramList[int.parse(widget.subOrder)].title,
