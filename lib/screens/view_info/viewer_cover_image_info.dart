...
class ViewerCoverImage extends StatefulWidget {
  ViewerCoverImage({this.id, this.type, this.pageId, });
  final String id;
  final String type;
  final String pageId;
...
class _ViewerCoverImageState extends State<ViewerCoverImage> {
  ...
  void initState() {
    ...
    data =  new CoverImageModel(imageURL: '');
    getXmapTitle();
    getCollections();
    getLastComment();
  ...
  void addNewCollection(String collectionTitle) async {
    ...
    collection.image = data.imageURL;
    collection.title = xmapTitle.title;
    collection.description = data.description;
    collection.tag = data.tag;
    collection.reference = data.reference;
