...
class _ViewerImageState extends State<ViewerImage>
  ...
  void addNewCollection(String collectionTitle) async {
    Collection collection = Collection(
        ...
        tag: '',
        reference: '');
    collection.image = imageList[int.parse(widget.subOrder)].imageURL;
    collection.link = imageList[int.parse(widget.subOrder)].link;
    collection.sectionType = 'image';
    collection.description = imageList[int.parse(widget.subOrder)].description;
    collection.tag = imageList[int.parse(widget.subOrder)].tag;
    collection.reference = imageList[int.parse(widget.subOrder)].reference;
              ...
              Container(
                ...
                child: GestureDetector(
                  ...
                  child: imageList.length != 0
                      ? imageList[int.parse(widget.subOrder)].link != ''
                          ? Link(
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(40.0),
                                child: CachedNetworkImage(
                                  imageUrl:
                                      imageList[int.parse(widget.subOrder)]
                                          .imageURL,
                                  width: MediaQuery.of(context).size.width,
                                  height:
                              ...
                              url: imageList[int.parse(widget.subOrder)].link,
                              onError: _showErrorSnackBar,
                            )
                          : ClipRRect(
                              borderRadius: BorderRadius.circular(40.0),
                              child: CachedNetworkImage(
                                imageUrl: imageList[int.parse(widget.subOrder)]
                                    .imageURL,
                                width: MediaQuery.of(context).size.width,
                                height:
                                    MediaQuery.of(context).size.height * 0.8,
