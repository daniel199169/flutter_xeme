...
class YouTube extends StatefulWidget {
  ...
  YouTube({this.id, this.type, this.subOrder, this.pageId});
...
class _YouTubeState extends State<YouTube> {
  ...
  void addNewCollection(String collectionTitle) async {
    Collection collection = Collection(
        ...
        tag: '',
        reference: '');
    collection.image = youtubeList[int.parse(widget.subOrder)].image;
    collection.videoURL = youtubeList[int.parse(widget.subOrder)].youtubeURL;
    collection.sectionType = 'youtube';
    collection.title = youtubeList[int.parse(widget.subOrder)].title;
    collection.description =
        youtubeList[int.parse(widget.subOrder)].description;
    collection.tag = youtubeList[int.parse(widget.subOrder)].tag;
    collection.reference = youtubeList[int.parse(widget.subOrder)].reference;
  ...
  void playYoutubeVideo() {
    FlutterYoutube.playYoutubeVideoByUrl(
      ...
      videoUrl: youtubeList[int.parse(widget.subOrder)].youtubeURL,
      autoPlay: true,
    );
  }
                    ...
                    child: youtubeList.length != 0
                        ? ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              imageUrl:
                                  youtubeList[int.parse(widget.subOrder)].image,
                              width: MediaQuery.of(context).size.width,
                  ...
                  child: Align(
                    ...
                    child: ListView(
                      children: <Widget>[
                        ...
                        Text(
                          youtubeList[int.parse(widget.subOrder)].title,
