...
class ViewerImage extends StatefulWidget {
  ViewerImage({this.id, this.type, this.subOrder, this.pageId, this.data});
  final String id;
  final String type;
...
class _ViewerImageState extends State<ViewerImage>
  ...
  void addNewCollection(String collectionTitle) async {
    Collection collection = Collection(
        ...
        tag: '',
        reference: '');
    collection.image = widget.data[int.parse(widget.subOrder)].imageURL;
    collection.link = widget.data[int.parse(widget.subOrder)].link;
            ...
            children: <Widget>[
              Container(
                ...
                child: GestureDetector(
                  ...
                  child: widget.data[int.parse(widget.subOrder)].link != ''
                      ? Link(
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(40.0),
                            child: CachedNetworkImage(
                              imageUrl: widget
                                  .data[int.parse(widget.subOrder)].imageURL,
                          ...
                          url: widget.data[int.parse(widget.subOrder)].link,
