...
class Vimeo extends StatefulWidget {
  ...
  final String pageId;
  var data;
  Vimeo({this.id, this.type, this.subOrder, this.pageId, this.data});
  @override
...
class _VimeoState extends State<Vimeo> {
  ...
  void addNewCollection(String collectionTitle) async {
    Collection collection = Collection(
        ...
        tag: '',
        reference: '');
    collection.image = widget.data[int.parse(widget.subOrder)].image;
    collection.videoURL = widget.data[int.parse(widget.subOrder)].vimeoURL;
  ...
  getVimeo() async {
    setState(() {
      _videoPlayerController = new VideoPlayerController.network(
        widget.data[int.parse(widget.subOrder)].vimeoURL,
      );
                  ...
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: widget.data[int.parse(widget.subOrder)].image,
