...
class YouTube extends StatefulWidget {
  ...
  final String pageId;
  var data;
  YouTube({this.id, this.type, this.subOrder, this.pageId, this.data});
...
class _YouTubeState extends State<YouTube> {
  ...
  void addNewCollection(String collectionTitle) async {
    ...
    collection.videoURL = widget.data[int.parse(widget.subOrder)].youtubeURL;
  ...
  void playYoutubeVideo() {
    FlutterYoutube.playYoutubeVideoByUrl(
      ...
      videoUrl: widget.data[int.parse(widget.subOrder)].youtubeURL,
      autoPlay: true,
    );
  }
